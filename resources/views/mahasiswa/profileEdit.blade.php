                    ...
                    <form action="{{route('AdminCreatePeminjamanPost')}}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputEmail4" value="{{$mahasiswa->nim}}" disabled name="nama_peminjam">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Jurusan</label>
                                <input type="text" class="form-control" id="inputEmail4" value="{{$mahasiswa->jurusan}}" name="nama_peminjam">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Jenis Kelamin</label>
                                <input type="text" class="form-control" id="inputEmail4" value="{{$mahasiswa->jenis_kelamin}}" disabled name="nama_peminjam">
                            </div>
                        </div>
